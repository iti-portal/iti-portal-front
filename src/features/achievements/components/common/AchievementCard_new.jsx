...
const AchievementCard = ({ 
  ...
  return (
    <motion.div
      ...
      onClick={handleView}
      className={`bg-white rounded-xl border border-gray-100 hover:border-gray-200 transition-all duration-200 cursor-pointer group overflow-hidden ${compact ? 'p-4' : 'p-6'} ${className}`}
    >
      {/* User Header */}
      {showUser && (
