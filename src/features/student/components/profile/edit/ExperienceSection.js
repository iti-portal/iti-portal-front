// src/features/student/components/profile/edit/ExperienceSection.js

import React from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { FaPlus, FaEdit, FaTrash, FaBriefcase, FaCalendarAlt } from 'react-icons/fa';

function ExperienceSection({ workExperiences = [], onAdd, onEdit, onDelete }) {
      ...
      <AnimatePresence>
        {workExperiences.length === 0 ? (
          <motion.div 
            ...
            exit={{ opacity: 0 }}
          >
            <FaBriefcase size={48} className="mx-auto mb-4 text-gray-300" />
            <p>No work experience entries yet. Add your professional experience to showcase your skills.</p>
          </motion.div>
        ) : (
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-[#901b20] font-medium mb-2">{experience.company}</p>
